...
pos_forward = GameObject.Find ("forward2").transform;
pos_backward = GameObject.Find ("backward2").transform;
pos_left = GameObject.Find ("left2").transform;
pos_right = GameObject.Find ("right2").transform;

pos_upforward = GameObject.Find ("upforward2").transform;
pos_upbackward = GameObject.Find ("upbackward2").transform;
pos_upleft = GameObject.Find ("upleft2").transform;
pos_upright = GameObject.Find ("upright2").transform;

pos_downforward = GameObject.Find ("downforward2").transform;
pos_downbackward = GameObject.Find ("downbackward2").transform;
pos_downleft = GameObject.Find ("downleft2").transform;
pos_downright = GameObject.Find ("downright2").transform;
