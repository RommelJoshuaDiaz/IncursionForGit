...
pos_forward = GameObject.Find ("forward4").transform;
pos_backward = GameObject.Find ("backward4").transform;
pos_left = GameObject.Find ("left4").transform;
pos_right = GameObject.Find ("right4").transform;

pos_upforward = GameObject.Find ("upforward4").transform;
pos_upbackward = GameObject.Find ("upbackward4").transform;
pos_upleft = GameObject.Find ("upleft4").transform;
pos_upright = GameObject.Find ("upright4").transform;

pos_downforward = GameObject.Find ("downforward4").transform;
pos_downbackward = GameObject.Find ("downbackward4").transform;
pos_downleft = GameObject.Find ("downleft4").transform;
pos_downright = GameObject.Find ("downright4").transform;
