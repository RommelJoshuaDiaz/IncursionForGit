...
pos_forward = GameObject.Find ("forward").transform;
pos_backward = GameObject.Find ("backward").transform;
pos_left = GameObject.Find ("left").transform;
pos_right = GameObject.Find ("right").transform;

pos_upforward = GameObject.Find ("upforward").transform;
pos_upbackward = GameObject.Find ("upbackward").transform;
pos_upleft = GameObject.Find ("upleft").transform;
pos_upright = GameObject.Find ("upright").transform;

pos_downforward = GameObject.Find ("downforward").transform;
pos_downbackward = GameObject.Find ("downbackward").transform;
pos_downleft = GameObject.Find ("downleft").transform;
pos_downright = GameObject.Find ("downright").transform;
